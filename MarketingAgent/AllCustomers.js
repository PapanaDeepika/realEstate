        ...
        <Card.Content>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailItem}>
              ...
              />
              <Text style={styles.detailText}>
                {i18n.t(customer.district)}, {i18n.t(customer.state)}
              </Text>
            </View>
          </View>
        </Card.Content>
        ...
        <>
          ...
          {filteredCustomers.length === 0 && (
            <View style={styles.noCustomersContainer}>
              ...
              <Text style={styles.noCustomersText}>{i18n.t("No Customers found")}</Text>
            </View>
          )}
            ...
            >
              <View style={styles.listContainer}>
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <CustomerDealCard customer={item} />
                  )}
                  scrollEnabled={false}
                />
              </View>
