...
function MarketingAgentDeals() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/deal/getDeals?text=${query}`,
        {
          method: "GET",
          headers: {
  ...
  const getCustomers = useCallback(async () => {
    try {
      ...
      const response = await fetch("https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/deal/getDeals", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        ...
        <Card.Content>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailItem}>
              ...
              <Text style={styles.detailText}>
                {formatPhoneNumber(customer.customer.phoneNumber)}
              </Text>
            </View>
            ...
            <View style={styles.detailItem}>
              ...
              />
              <Text style={styles.detailText}>
                {i18n.t(customer.customer.district)}, {i18n.t(customer.customer.state)}
              </Text>
            </View>
          </View>
        </Card.Content>
      ...
      {loading ? (
        ...
        <>
          <View style={styles.searchContainer}>
            <TextInput
              placeholder={  
                i18n.t("Search By Customer Id, Name, Location")
               }
