    ...
    try {
      ...
      if (validateForm()) {
        ...
        const response = await axios.post(
          "https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/customer/insertSurvey",
          data,
          {
            headers: {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.container}>
        ...
        {errors.contactStatus && (
          <Text style={styles.errorText}>{errors.contactStatus}</Text>
        )}
        {contactStatus === "0" && (
          <>
            <Text style={styles.label}>
        ...
        >
          <Text style={{ fontSize: 18, color: "#fff",      fontFamily: "Montserrat_600SemiBold",
 }}>
            Submit
          </Text>
        </TouchableOpacity>
