...
const CommercialFormAgent = () => {
  ...
  const [priceUnit, setPriceUnit] = useState("/acre");
  ...
  const handlePincodeChange = async (text) => {
    ...
    await axios({
      ...
      //  Authorization: `Bearer ${'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..cdi4KJr-GmolcqnKaggduv-RxzZWA6zHd3h3l9vSDWU'}`, // Include the token in headers
      setAddress({
        ...address,
              ...
              {agents.length > 0 ? (
                agents.map((agent) => (
                  <Picker.Item
                    ...
                    value={agent._id} // Use agent's ID as value
                  />
                ))
              ) : (
...
export default CommercialFormAgent;
