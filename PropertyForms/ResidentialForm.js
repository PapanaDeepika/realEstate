...
//   }, []);
 ...
 />
 <Text style={styles.label1}>Property Name</Text>
 <TextInput
 ...
 />
 <Text style={styles.label1}>Property Number</Text>
 <TextInput
 ...
 />
 <Text style={styles.label1}>Flat Size</Text>
 ...
 <Text style={styles.label1}>Flat Cost</Text>
 <View style={styles.row}>
 ...
 <Text style={styles.label1}>Total Cost</Text>
 <TextInput
 ...
 <View style={styles.inputContainer}>
  ...
  <Text style={styles.label1}>Property Layout
  </Text>
 ...
 /> */}
 <View style={styles.inputContainer}>
 <Text style={styles.label1}>Property Facing</Text>
...
<View style={styles.inputContainer}>
  ...
  <Text style={styles.label1}>Furniture</Text>
  <Picker
 placeholder="Property Facing"
...
{selectedLocation && (
 ...
 <Text style={styles.label1}>LandMark</Text>
 <TextInput
 ...
 <Text style={styles.label1}>Power Supply</Text>
 ...
 /> */}
 <View style={styles.switchContainer}>
 <Text style={styles.label1}>Water Facility</Text>
 <Switch value={waterFacility} onValueChange={setWaterFacility} />
 </View>
 {/* Dropdown */}
 <View style={styles.row}>
 <Text style={styles.label1}> Electricity Facility</Text>
 <Picker
 ...
 {/* dropdown */}
 <View style={styles.switchContainer}>
 <Text style={styles.label1}>Gym facility</Text>
 <Switch value={gymFacility} onValueChange={setGymFacility} />
 </View>
 {/* switch */}

 <View style={styles.switchContainer}>
 <Text style={styles.label1}>Elevator</Text>
 <Switch value={elevator} onValueChange={setElevator} />
 </View>
 {/* switch */}

 <View style={styles.switchContainer}>
 <Text style={styles.label1}>Watchman</Text>
...
type: [String],
 ...
 /> */}
 <Text style={styles.label1}>Water Source</Text>
 ...
 /> */}
 <View style={styles.row}>
 <Text style={styles.label1}>Nearest Road Type</Text>
 <Picker
 ...
 <TextInput
 placeholder="Enter Videos (comma separated)"
 value={videos}
