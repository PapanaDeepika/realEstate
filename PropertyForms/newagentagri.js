    ...
    if(validateForm())
{
        ...
        <>
            <ScrollView>
                ...
                <View style={styles.container}>
                    ...
                    />
                    {OwnerNameerror ? <Text style={styles.errorText}>{OwnerNameerror}</Text> : null}
                    ...
                    {isDispute && (
                        <View style={styles.textAreaContainer}>
                            <Text style={styles.label}>Description (Required for disputes) <Text style={{color:"red"}}>*</Text></Text>
                            <TextInput
                                style={[styles.textArea,errors.litigationDesc && styles.inputError]}
                    ...
                    <Text style={styles.label1}>Land Type <Text style={{color:'red'}}>*</Text></Text>

                    <View  style={[styles.pickerWrapper1 ,errors.landType&&styles.pickerError]}>
                    ...
                    {errors.landType && <Text style={styles.errorText}>{errors.landType}</Text>}
                    ...
                    />
                    {LandNameerror ? <Text style={styles.errorText}>{LandNameerror}</Text> : null}
                    {errors.landName && <Text style={styles.errorText}>{errors.landName}</Text>}

                    <Text style={styles.label1}>Survey No <Text style={{color:'red'}}> *</Text></Text>
                    <TextInput
                    ...
                    />
                    {errors.surveyNo && <Text style={styles.errorText}>{errors.surveyNo}</Text>}

                    <Text style={styles.label1}>Land Size <Text style={{color:'red'}}>*</Text></Text>
                    <View style={styles.inputContainer}>
                        ...
                        />
                         ...
                         <View style={[styles.pickerWrapper ,errors.sizeUnit&&styles.pickerError]}>
                            <Picker
                    ...
                    {LandSizeerror ? <Text style={styles.errorText}>{LandSizeerror}</Text> : null}
                    {errors.sizeUnit && <Text style={styles.errorText}>{errors.sizeUnit}</Text>}

                    <Text style={styles.label1}>Price <Text style={{color:'red'}}>*</Text></Text>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <View  style={[styles.pickerWrapper ,errors.priceUnit&&styles.pickerError]}>
                            <Picker
                    ...
                    {LandPriceerror ? <Text style={styles.errorText}>{LandPriceerror}</Text> : null}
                     {errors.price && <Text style={styles.errorText}>{errors.price}</Text>}
                     {errors.priceUnit && <Text style={styles.errorText}>{errors.priceUnit}</Text>}

                    <Text style={styles.label1}>Total Price  <Text style={{color: 'red'}}>*</Text></Text>
                    ...
                    <TextInput
                        ...
                        style={[styles.input, styles.pincodeInput, errors.pincode&&styles.inputError]}
                    />
   ...
   {errors.pinCode && <Text style={styles.errorText}>{errors.pincode}</Text>}
                    ...
                    />
                    <Text style={styles.label1}>Electricity Type <Text style={{color:'red'}}>*</Text></Text>

                    {/* <View style={{ borderColor: 'black', borderWidth: 1, borderRadius: 5 }}> */}
                    <View style={[styles.pickerWrapper1 ,errors.eleType&&styles.pickerError]}>
                        <Picker
                    ...
                    {errors.eleType && <Text style={styles.errorText}>{errors.eleType}</Text>}
                    ...
                    <TextInput style={[styles.input]} placeholder="Enter distance in Kms" keyboardType="numeric" value={distance}
                        onChangeText={(value) => {
                     const regex = /^[0-9]*\.?[0-9]*$/;   
                    ...
                    <Text style={styles.label1}>Select Road Type <Text style={{color:'red'}}>*</Text></Text>
                    {/* <View style={{ borderColor: 'black', borderWidth: 1, borderRadius: 5 }}> */}
...
{selectedLocation && (
 ...
 {loading?(
    <ActivityIndicator size="small" color="blue" style={{flex:1,justifyContent:"center",alignItems:"center"}}/>
 ):(
