...
const drawer= createDrawerNavigator()
        ...
        <TouchableOpacity onPress={() => { 
         ...
         <TouchableOpacity onPress={() => { 
          ...
          <Symbol 
            ...
            onPress={() => {navigation.navigate('Login')}} // Add some margin for spacing
          />
        </TouchableOpacity>
        </View>
      ),
  ...
  const handleSeeAllPress = () => {
    ...
    navigation.navigate("ViewpropbyCSR")
  };
  ...
  return (
    ...
    <View style={{ paddingRight: 10, paddingLeft: 10 }}>
        ...
        <View>
          <Text style={{ fontWeight: 600, fontSize: 22, marginLeft: 10, color: "#003B73", marginTop:10, marginBottom:5 }}>Today</Text>
      ...
      <TouchableOpacity style={styles.iconWrapper}>
        <Icon name="home" size={30} color="#0d416b" onPress={() => {
      ...
      <TouchableOpacity style={styles.iconWrapper}>
        <Icon name="user" size={30} color="#0d416b" />
        <Text style={styles.iconText}>Customers</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.iconWrapper}>
        <Icon name="handshake-o" size={30} color="#0d416b" />
        <Text style={styles.iconText}>Deals</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.iconWrapper}>
        <Icon name="calendar" size={30} color="#0d416b" />
        <Text style={styles.iconText}>Calendar</Text>
      </TouchableOpacity>
    </View>
        <View style={styles.textStyle}>
          <Text style={{ fontWeight: "900", fontSize: 22, color: "#0d416b" , marginTop:10}}>Latest Deals</Text>
          <TouchableOpacity onPress={handleSeeAllPress}>
            <Text style={{ color: 'blue', textDecorationLine: 'underline', marginRight: 10,  marginTop:10 }}>See All</Text>
          </TouchableOpacity>
        </View>
        <FlatList
          ref={flatListRef}
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    ...
    paddingHorizontal: 20, // Add padding from sides
  ...
  iconText: {
    fontSize: 12, // Small font for the label
    color: '#0d416b',
