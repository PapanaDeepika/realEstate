...
export default function LoginScreen() {
  ...
  const handleEmailChange = (text) => {
    ...
    const emailPattern =
      /^[a-zA-Z0-9._%+-]+@(gmail\.com|[a-zA-Z.-]+\.(com|in|org|co|net))$/;
  ...
  //  // https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/login--- chandini's

  //  // axios.post(" https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/login", userData)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/login",
        userData
      );
      ...
      if (error.response) {
        if (
          ...
          Alert.alert(
            "Email is registered, but you have entered the wrong password."
          );
        } else if (
