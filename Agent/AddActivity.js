...
const AddActivity = ({ route }) => {
 ...
 const param = route.params.deal
  ...
  const [dropdownItems, setDropdownItems] = useState([
    { label: i18n.t('On Call'), value: 'On Call' },
    { label: i18n.t('One to One'), value: 'One to One' }
  ]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/activity/add', {
        method: 'POST',
        headers: {
    ...
    <View style={styles.container}>
      <View style={styles.modalContent}>
        <Text style={styles.label}>
          {i18n.t("Select Date")} <Text style={styles.required}>*</Text>
        </Text>
        <TouchableOpacity
          style={[
            styles.input,
        ...
        <Text style={styles.label}>
          {i18n.t("Start Time")}<Text style={styles.required}>*</Text>
        </Text>
        <TouchableOpacity
          style={[
            styles.input,
...
<Text style={styles.label}>
          {i18n.t("Activity Type")} <Text style={styles.required}>*</Text>
        </Text>
        <DropDownPicker
          open={open}
          ...
          setItems={setDropdownItems}
           placeholder={i18n.t("Select an activity type")}
           zIndex={2000}
        ...
        <Text style={styles.label}>
          {i18n.t("Location")} <Text style={styles.required}>*</Text>
        </Text>


        {selectedActivityType!=="One to One"&&( <View>     
             <TextInput style={[
            styles.textInput,
        ...
        <Text style={styles.label}>{i18n.t("Feed Back")} <Text style={styles.required}>*</Text></Text>
        <TextInput
          style={[styles.textInput, { textAlignVertical: 'top' }]}
          placeholder={i18n.t("Enter activity details")}
          value={feedBack}
