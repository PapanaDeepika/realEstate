...
//             const response = await fetch(`https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/deal/dealSearchOnCustomer/${query}`, {
//                 method: "GET",
//                 headers: {
...
//             const response = await fetch(" https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/deal/getIntresetedCustomers", {
//                 method: "GET",
//                 headers: {
//                     Authorization: `Bearer ${token}`,
//                     "Content-Type": "application/json",
...
// navigation.navigate("getDealByCId", {customer:customer})
//   }
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/deal/dealSearchOnCustomer/${query}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
...
console.log("pagess",page)
      ...
      const response = await fetch(
        `https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app//deal/getIntresetedCustomers?page=${page}&limit=8`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    return (
      <Card style={styles.card}>
        <Card.Content>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detailItem}>
              ...
              />
              <Text style={styles.detailText}>
                {i18n.t(customer.district) || "N/A"},{" "}
                {i18n.t(customer.state) || "N/A"}
              </Text>
            </View>
          </View>
        </Card.Content>
        ...
        >
          ...
          >
            <Text style={{ color: "white", fontSize: 16,fontFamily:"Montserrat_500Medium" }}>{i18n.t("View Deals")}</Text>
          </TouchableOpacity>
        </View>
      </Card>
    );
            ...
            <View style={styles.listContainer}>
              <Animated.FlatList
                ...
                onEndReachedThreshold={0.5}
                 ...
                 ListFooterComponent={<>{loading1?(<ActivityIndicator size={"large"} color={"#057ef0"} />):(null)}</>}
              />
            </View>
          )}
...
const styles = StyleSheet.create({
 ...
 textAlign:"justify"
  ...
  filterButton: {
    ...
    borderWidth: 1,
    borderRadius: 5,
    fontFamily:"Montserrat_00Medium",
