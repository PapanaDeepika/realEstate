...
{(activity.activityType === 'On Call' || activity.activityType === 'call') && (
    ...
    const getActivities = useCallback(async () => {
        try {
            ...
            const response = await fetch(`https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/activity/activities?agentId=${agentId}&dealingId=${dealId}`, {
                method: "GET",
                headers: {
