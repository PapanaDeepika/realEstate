      ...
      >
        ...
        <View style={styles.cardHeader}>
          ...
          >
            ...
            {(customer.dealStatus === "inProgress"||customer.dealStatus === "open")&&(<Menu.Item
        ...
        <View style={styles.cardBody}>
          <View style={styles.infoContainer}>
            ...
            <View style={styles.infoItem}>
              ...
              />
              <Text style={styles.infoText}>
                {i18n.t(customer.customer.district) || "N/A"},{" "}
                {i18n.t(customer.customer.state) || "N/A"}
              </Text>
            </View>
          </View>
        ...
        {(customer.dealStatus === "In Progress" ||
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              style={styles.button}
              onPress={() => {
                scheduleMeet(property, customer);
              }}
            >
