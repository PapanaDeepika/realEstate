  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/booking/userbook",
        requestData,
        {
          headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        <Image
          source={{ uri: agentDetails.agentProfilePicture }}
          style={styles.profileImage}
        />
        <View style={styles.profileDetails}>
          <Text style={styles.profileName}>{agentDetails.agentName}</Text>
          <Text style={styles.profileInfo}>
            Mobile: {agentDetails.agentNumber}
          </Text>
      ...
      <View style={styles.form}>
        ...
        <TouchableOpacity
          ...
          style={[styles.inputContainer, errors.time && styles.inputError]}
        >
