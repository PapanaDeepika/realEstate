...
const AdvanceSearchScreen = ({ route }) => {
  ...
  const handleSearch = async () => {
    ...
    try {
      // const apiUrl = " https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/filterRoutes/residentialSearch";
      ...
      if (selectedCategory && type === "residential")
        params.purchaseType = selectedCategory;
      ...
      if (selectedCategory && type === "commercial")
        params.propertyFor = selectedCategory;
    ...
    <ScrollView style={{ padding: 16 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.wrap}>
            {["Flat", "Apartment", "House"].map((item) => (
              <Chip
                ...
                onPress={() =>
                  setPropertyType((prev) => (prev === item ? null : item))
                }
          ...
          <View style={styles.wrap}>
            {["1 BHK", "2 BHK", "3 BHK", "4 BHK", "4+ BHK"].map((item) => (
              <Chip
                ...
                onPress={() =>
                  setBedroom((prev) => (prev === item ? null : item))
                }
          ...
          <View style={styles.wrap}>
            {["North", "South", "East", "West"].map((item) => (
              <Chip
                ...
                onPress={() =>
                  setFacing((prev) => (prev === item ? null : item))
                }
          ...
          <View style={styles.row}>
            {["Furnished", "Semi-Furnished", "Unfurnished"].map((item) => (
              <Chip
                ...
                onPress={() =>
                  setFurnishing((prev) => (prev === item ? null : item))
                }
      ...
      <View style={styles.row}>
        <TextInput
          ...
          style={[styles.input, { width: (screenWidth - 40) / 2 }]}
          value={area}
      ...
      {type === "commercial" && (
        <>
          ...
          <View style={styles.wrap}>
            {["Retial", "Industrial", "Hospitality", "Social Activities"].map(
              (item) => (
                <Chip
                  key={item}
