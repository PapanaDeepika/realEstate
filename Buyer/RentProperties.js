...
function RentProperties({ navigation }) {
  ...
  const fetchProperties = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch("https://real-estate-back-end-y58p-git-main-pindu123s-projects.vercel.app/commercials/getProperties/rent", {
        method: "GET",
        headers: {
