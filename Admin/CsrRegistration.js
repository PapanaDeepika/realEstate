...
function CsrRegistration() {
  ...
  const getMandals = async(district) =>{
    ...
    // http://172.17.15.189:3000/location/getmandals/Vizianagaram

    try {
      const response = await axios.get(`http://172.17.15.189:3000/location/getmandals/${district}`);
      ...
      console.error(error, `http://172.17.15.189:3000/location/getmandals/${district}`);
